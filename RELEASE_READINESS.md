...
5. Verify App Store Connect build processing, tester access, metadata/screenshots/privacy answers and review access. Confirm the final product name against prior clearance work; current code is Veystead Beta. Do not restart naming from assumptions.
