...
assert.match(terms,/Benjamin George Churchill trading as Veystead/);
assert.match(terms,/8 Halifax Drive/);
assert.doesNotMatch(terms,/public business identity and service address must be added/);
assert.match(privacy,/Benjamin George Churchill trading as Veystead/);
assert.match(privacy,/IP12 2FN/);
assert.doesNotMatch(privacy,/final product\/business identity/);
