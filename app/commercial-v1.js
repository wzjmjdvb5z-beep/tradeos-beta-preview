(()=>{
  ...
  function openInvoiceDetail(id,ctx){
    ...
    document.body.appendChild(overlay);
    overlay.querySelector('[data-invoice-print]')?.addEventListener('click',()=>printInvoice(i,job,customer,items,payments));
  ...
  function printInvoice(invoice,job,customer,items,payments){
