(()=>{
  ...
  async function mount(){
    ...
    card.innerHTML=`<div class="tos-employee-onboarding-head"><div><span>TEST EMPLOYEE VIEW</span><h3>Open TradeOS on your partner’s phone</h3></div><button type="button" data-employee-share>Share app link</button></div><ol><li><b>1</b><span><strong>Add their email</strong><small>Tap “Invite a team member” above and keep the role as Employee.</small></span></li><li><b>2</b><span><strong>Create their account</strong><small>Open the shared link on their phone and use the exact invited email.</small></span></li><li><b>3</b><span><strong>Sign in as the employee</strong><small>The invitation joins them to your workspace automatically.</small></span></li></ol><div class="tos-employee-invite-status" data-employee-status>Checking invitations…</div></section>`;
